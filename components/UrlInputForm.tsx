  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-lg">
        <h2 className="text-2xl font-bold text-center text-gray-800 mb-2">Informações da Empresa</h2>
        <p className="text-center text-gray-600 mb-8">Preencha os dados para a IA analisar e criar seu marketingboard. Se tiver um site, a análise será mais precisa.</p>
        <form onSubmit={handleSubmit} className="space-y-4">
          <input
            ...
            disabled={isLoading}
            className="w-full bg-gray-100 text-gray-800 placeholder-gray-400 px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-colors duration-200 disabled:opacity-50"
            required
          />
          <input
            name="address"
