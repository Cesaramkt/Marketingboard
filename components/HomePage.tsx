...
const FeatureCard: React.FC<{icon: React.ReactNode, title: string, children: React.ReactNode}> = ({ icon, title, children }) => (
    <div className="bg-slate-800/50 backdrop-blur-sm p-6 rounded-xl border border-white/10 text-center transform transition-all duration-300 hover:-translate-y-2 hover:bg-slate-800">
        {icon}
        <h3 className="font-bold text-xl mb-2 text-slate-100">{title}</h3>
...
const featureIcons = {
    creation: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 mb-4 text-fuchsia-400 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    structured: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 mb-4 text-cyan-400 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />
        </svg>
    ),
    download: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 mb-4 text-violet-400 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
        </svg>
    ),
    // FIX: Replaced malformed SVG with a correct version to resolve multiple parsing errors.
    easy: (
         <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 mb-4 text-fuchsia-400 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <div className="min-h-screen w-full flex flex-col justify-center items-center p-4 relative">
        ...
        <div className="relative z-10 flex flex-col items-center text-center max-w-4xl w-full">
            <div className="relative p-8 md:p-10">
                <h1 className="text-6xl md:text-8xl font-serif font-bold text-slate-100 tracking-tighter">
                    Marketingboard
                </h1>
                <p className="mt-4 text-lg md:text-xl text-slate-300 max-w-lg mx-auto">
       ...
       <div className="py-20 px-4 bg-slate-900 relative z-10">
          <div className="max-w-6xl mx-auto text-center">
              <h2 className="text-4xl md:text-5xl font-serif font-bold mb-4 text-slate-100">As vantagens de usar o Marketingboard</h2>
              <p className="text-lg text-slate-400 mb-12 max-w-3xl mx-auto">Uma solução completa para criar, gerenciar e compartilhar suas diretrizes de marca e marketing de forma inteligente.</p>
