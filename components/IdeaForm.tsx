        ...
        <div className="w-full">
            <div className="max-w-2xl mx-auto">
                ...
                <div className="bg-white/80 dark:bg-slate-800/50 backdrop-blur-sm p-6 sm:p-8 rounded-2xl shadow-lg border border-gray-200 dark:border-slate-700">
                    <h2 className="text-3xl font-bold text-center text-gray-900 dark:text-slate-100 mb-2 font-['Playfair_Display',_serif]">Vamos dar vida à sua ideia</h2>
                    <p className="text-center text-gray-600 dark:text-slate-400 mb-8">Preencha os campos abaixo para a IA criar um conceito de marca inicial para você.</p>
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <input 
                            ...
                            className="w-full bg-gray-50 dark:bg-slate-700 text-gray-900 dark:text-slate-100 placeholder-gray-400 px-4 py-3 rounded-lg border border-gray-300 dark:border-slate-600 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-colors duration-200"
                            required 
                        />
                        <textarea 
                            value={description} 
