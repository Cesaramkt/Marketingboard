    ...
    return (
        <div className="max-w-2xl mx-auto">
            ...
            <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-lg">
                <h2 className="text-2xl font-bold text-center text-gray-800 mb-2">Vamos dar vida à sua ideia</h2>
                <p className="text-center text-gray-600 mb-8">Preencha os campos abaixo para a IA criar um conceito de marca inicial para você.</p>
